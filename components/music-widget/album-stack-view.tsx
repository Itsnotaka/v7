  ...
  return (
    <div className="flex flex-col gap-6">
      <header className="flex items-center justify-between">
        <h2 className="text-foreground text-sm font-medium tracking-tight">Listening to...</h2>
        <Button variant="outline" size="default" onClick={onRefresh} disabled={isLoading}>
          <ArrowsClockwiseIcon
